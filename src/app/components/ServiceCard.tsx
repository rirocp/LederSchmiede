...
export default function ServiceCard({ service }: ServiceCardProps) {
  return (
    <div className="group relative h-full">
      ...
      <div className="relative h-full bg-white/90 backdrop-blur-xl rounded-3xl overflow-hidden border border-[#AA8C5B]/30 hover:border-[#BF6C3E]/50 transition-all duration-700 hover:-translate-y-3 hover:shadow-2xl hover:shadow-[#BF6C3E]/20">
        ...
        <div className="p-8 flex flex-col flex-grow justify-between">
          ...
          <Link
            ...
            className="group/btn relative overflow-hidden bg-[#BF6C3E] text-white py-4 px-6 rounded-2xl font-medium text-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-[#BF6C3E]/25"
          >
